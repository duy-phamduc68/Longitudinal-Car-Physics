"""
Car Physics Simulator - Model 3 (drivetrain + load transfer)
================================
...
from constants import CONST_FIELDS, THROTTLE_RAMP_DEFAULT, TIMESTEP_OPTIONS, FPS_OPTIONS, UPSHIFT_RPM, DOWNSHIFT_RPM
...
class Simulator:
    ...
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Car Physics Simulator - Model 3")
    ...
    def _physics_step(self, dt):
        a, F_eng, F_rr, F_drag, F_brake, _wf, _wr, _dw = self.car.update(
            dt, self._drive_throttle, self._drive_brake)
        self.sim_time += dt
